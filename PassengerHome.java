...
public class PassengerHome extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.search_bus) {
            startActivity(new Intent(getApplicationContext(),Passenger_SearchBus.class));
        } else if (id == R.id.owner_section) {

            SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
            if(sh.getString("user_type","").equalsIgnoreCase("owner")){
            ...
            startActivity(new Intent(getApplicationContext(),Owner_AddBus.class));
        }
